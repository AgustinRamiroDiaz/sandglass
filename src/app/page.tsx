...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4 relative">
      ...
      {/* GitHub Button */}
      <a
        href="https://github.com/AgustinRamiroDiaz/sandglass"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-4 left-4 p-4 bg-gray-700 hover:bg-gray-800 text-white rounded-full shadow-lg transition-all hover:scale-110 active:scale-95 z-10"
        ...
        >
          ...
          >
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <div>
                <p className="text-sm mb-4 pb-4 border-b border-gray-200 dark:border-gray-600">
                  This timer was originally designed for the board game <span className="font-semibold">Magic Maze</span>,
                  featuring a flip mechanic inspired by the game&apos;s sandglass timer.
                </p>
              </div>
              <div>
